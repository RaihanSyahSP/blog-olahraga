...
<aside class="w-full md:w-1/3 flex flex-col items-center px-3">
    ...
    <div class="w-full bg-white shadow flex flex-col my-4 p-6">
        ...
        <a href="{{ route('about-us') }}" class="w-full bg-green-500 text-white font-bold text-sm uppercase rounded hover:bg-green-600 flex items-center justify-center px-2 py-3 mt-4">
            Get to know us
        </a>
    </div>
